...
public class OthelloGUI extends JComponent implements MouseListener
{
  static final long 	serialVersionUID = 1234567890;
    ...
    public OthelloGUI(IOthelloAI ai1, IOthelloAI ai2, int size, boolean humanPlayer) throws IOException{
   		part = ImageIO.read(Othello.class.getResource("imgs/maze.png"));
    	blackPion = ImageIO.read(Othello.class.getResource("imgs/blackPion.png"));
    	whitePion = ImageIO.read(Othello.class.getResource("imgs/whitePion.png"));
    	background = ImageIO.read(Othello.class.getResource("imgs/background.png"));
    	border_left = ImageIO.read(Othello.class.getResource("imgs/border_left.png"));
    	border_right = ImageIO.read(Othello.class.getResource("imgs/border_right.png"));
    	border_top = ImageIO.read(Othello.class.getResource("imgs/border_top.png"));
    	border_bottom = ImageIO.read(Othello.class.getResource("imgs/border_bottom.png"));
    	corner_left_top = ImageIO.read(Othello.class.getResource("imgs/corner_left_top.png"));
    	corner_left_bottom = ImageIO.read(Othello.class.getResource("imgs/corner_left_bottom.png"));
    	corner_right_top = ImageIO.read(Othello.class.getResource("imgs/corner_right_top.png"));
    	corner_right_bottom = ImageIO.read(Othello.class.getResource("imgs/corner_right_bottom.png"));
    	blackWon = ImageIO.read(Othello.class.getResource("imgs/blackWon.png"));
    	whiteWon = ImageIO.read(Othello.class.getResource("imgs/whiteWon.png"));
    	tie = ImageIO.read(Othello.class.getResource("imgs/tie.png"));
